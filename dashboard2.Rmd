...
Through `r last(weekly$week)`, Madagascar has officially registered `r last(weekly$week)` cases and `r last(weekly$cum.deaths)`.

Using data on deaths that occurred and the number of cases, we can estimate the case fatality ratio. The CFR is defined as the proportion of **confirmed COVID-19 deaths** over the number of **confirmed COVID19 cases**.
