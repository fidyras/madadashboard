...
cases_region%>%group_by(region)%>%summarise(cases=sum(cases),deaths=sum(death))->region_cumulative #sum of cases by region since March
...
ggplot(pop_age_Region,aes(x=cases,y=n60))+
  geom_point(aes(size=pop,color=deaths))+
