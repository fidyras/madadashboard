...
Testing laboratories include [Institut pasteur de Madagascar](www.pasteur.mg), [the Centre d'Infectiologie Charles Merieux](https://cicm-madagascar.com), the HJRA hospital and the Laboratoire d'Analyses Medicales de Madagascar. 
  
**The details and accuracy of the figures presented here are contingent upon the _publicly available_ information communicated by the Government of Madagascar _through the press_.**   
\
\
...
\
**Contributors**:
Fidisoa Rasambainarivo, Santatriniaina Randrianarisoa, Tanjona Ramiadantsoa, Benjamin Rice Malavika Rajeev and C. Jessica Metcalf,  .
...
**On July 2nd 2020, the press briefings failed to report the location (region) of a number of positive cases. It is unclear whether these were from patients in any of the affected regions or in "new regions"** 

**Age and sex of deceased individuals are not reported anymore either.**
...
bins <- pretty(cases_by_region$cases,n=6)
pal <- colorNumeric("Paired", domain = mada_regions$cases)
...
Testing is available in the country mainly for suspected cases. The [Institut Pasteur de Madagascar](www.pasteur.mg) acquired the capabilities to conduct the tests in January 2020 and has conducted more than 14 000 tests so far. Recently, three other laboratories acquired the capabilities to conduct the tests too. Collectively, these laboratories conduct **on average `r format(round(last(na.trim(ntl.cases$tests.mov.avg)),2),big.mark = ",")` every day  (5 day moving average)**.
