...
Row {data-width=650,data-height=900}
-----------------------------------------------------------------------
...
bins <- c(0,50,100,200,500,1000,2000,4000,8000,16000)
pal <- colorBin("RdYlBu", domain = mada_regions$cases,bins=bins,reverse=TRUE)
labels <- sprintf(
...
map <-leaflet()  %>%
  ...
  addPolygons(data = mada_regions,
              ...
              labelOptions = labelOptions(
                ...
                textsize = "15px",
                direction = "auto")) %>%
  addLegend("topleft", pal = pal, values = bins, title = f.tr("map_of_cases_legend_caption"))
