...
### `r format(f.tr("time_series_b_header"))` & `r format(f.tr("time_series_c_header"))` (Option1)
...
### `r format(f.tr("time_series_b_header"))` (Option2)
...
### `r format(f.tr("time_series_d_header"))` <br> (Option2)
