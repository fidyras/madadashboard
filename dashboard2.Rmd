...
```{r cfr}
weekly<-weekly%>%
  mutate(cum.deaths=cumsum(n.deaths),cfr=round(cum.deaths/cum.cases*100,4))
...
a%>%
  ...
  group_by(region)%>%
  mutate(cum.deaths=cumsum(death),cum.cases=cumsum(cases),cfr=round(cum.deaths/cum.cases,4)*100)->a
